...
Python dictionary that maps the sender's mail address to a 
...
sorted_list = sorted([(v,k) for k,v in counts.items()], reverse=True)
max_committer = sorted_list[0]
print(str(max_committer[1]), max_committer[0])